...
export default async function FourStancePage() {
  ...
  return (
    <div style={{ padding:'3rem', background:'#080808', minHeight:'100vh' }}>
      <h1 style={{ fontFamily:'serif', fontStyle:'italic', fontSize:'clamp(2rem,4vw,3rem)', color:'#f8f6f2', fontWeight:300, marginBottom:'0.3rem' }}>4スタンス談義</h1>
      <div style={{ width:40, height:2, background:'#e74c3c', marginBottom:'3rem' }}></div>
      <div style={{ display:'flex', flexDirection:'column', gap:'1.5rem' }}>
        {posts?.map((post: any) => (
          <article key={post.id} style={{
            ...
            padding:'2rem 2.5rem',
            position:'relative',
            boxShadow:'0 4px 24px rgba(0,0,0,0.4), inset 0 0 60px rgba(231,76,60,0.12)',
          }}>
            <div style={{ position:'absolute', top:0, left:0, right:0, height:1, background:'linear-gradient(90deg,#e74c3c,transparent)' }}></div>
            <div style={{ fontSize:'0.58rem', letterSpacing:'0.3em', color:'#e74c3c', opacity:0.7, marginBottom:'0.8rem' }}>
