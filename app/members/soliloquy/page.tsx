  ...
  return (
    <main style={{ minHeight:'100vh', background:'#080808', padding:'4rem 2rem', fontFamily:'sans-serif' }}>
      <div style={{ maxWidth:720, margin:'0 auto' }}>
        ...
        <h1 style={{ fontFamily:'serif', fontStyle:'italic', fontSize:'3rem', color:'#f8f6f2', margin:'2rem 0', fontWeight:300 }}>シンディの独り言</h1>
        <div style={{ display:'flex', flexDirection:'column', gap:'2px' }}>
          {posts?.map((post: any) => (
            <div key={post.id} style={{ background:'#111', border:'1px solid rgba(255,255,255,0.07)', padding:'2rem', position:'relative' }}>
