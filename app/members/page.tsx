...
export default function MembersPage() {
  const CONTENTS = [
    { icon:'💃', title:'Monthly Dance Lesson', sub:'月1回以上更新 — 動画レクチャー', href:'/members/lesson', badge:'Monthly' },
    { icon:'✍️', title:'シンディの独り言', sub:'日常・思考・音楽・旅のテキスト', href:'/members/soliloquy', badge:'' },
    { icon:'📈', title:'相場配信', sub:'GOLD / FX SHINDYの視点', href:'/members/market', badge:'Live' },
