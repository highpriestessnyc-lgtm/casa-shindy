  ...
  return (
    <div style={{ display:'flex', minHeight:'100vh', background:'#080808' }}>
      <aside style={{ width:220, background:'#111', borderRight:'1px solid rgba(255,255,255,0.07)', padding:'2rem 0', flexShrink:0 }}>
        ...
        <div style={{ padding:'1.5rem', marginTop:'2rem', borderTop:'1px solid rgba(255,255,255,0.07)' }}>
          <Link href="/" style={{ fontSize:'0.6rem', letterSpacing:'0.2em', color:'rgba(248,246,242,0.25)', textDecoration:'none' }}>← サイトへ</Link>
        </div>
      </aside>
      <main style={{ flex:1, padding:'3rem', overflowY:'auto' }}>{children}</main>
    </div>
  )
}