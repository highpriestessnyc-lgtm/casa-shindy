  ...
  return (
    <div>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'1rem' }}>
        <a href="/admin/posts/new" style={{ textDecoration:'none' }}>
          <div style={{ background:'rgba(201,169,110,0.08)', border:'1px solid rgba(201,169,110,0.2)', padding:'2rem' }}>
            <div style={{ fontSize:'2rem', marginBottom:'1rem' }}>✍️</div>
            <div style={{ fontSize:'1.1rem', color:'#f8f6f2', marginBottom:'0.3rem' }}>New Post</div>
            <div style={{ fontSize:'0.7rem', color:'rgba(248,246,242,0.35)' }}>Soliloquy / Market / Movies / Books</div>
          </div>
        </a>
